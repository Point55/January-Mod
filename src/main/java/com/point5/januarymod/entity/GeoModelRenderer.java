...
public class GeoModelRenderer<T extends EntityLiving & IAnimatable> extends GeoEntityRenderer<T>
{

	public GeoModelRenderer(RenderManager rendermanagerIn, AnimatedGeoModel<T> modelProvider)
    {
        super(rendermanagerIn, modelProvider);
    }
