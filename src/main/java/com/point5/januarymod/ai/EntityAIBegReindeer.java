...
public class EntityAIBegReindeer extends EntityAIBase
{
    private final EntityReindeer custom;
    private EntityPlayer player;
    private final World world;
    private final float minPlayerDistance;
    private int timeoutCounter;

    public EntityAIBegReindeer(EntityReindeer custom, float minDistance)
    {
        this.custom = custom;
